    ...
    if($_SESSION['rol']==2){
                ...
                <html class="no-js">
                  ...
                  <header>
                    ...
                    <a href="createmoneda.php"><button class="btn btn-default btn-call-to-action">Crear moneda</button></a> <br>
                    <table id="tabla">
                        <tr>    
                            <th>&nbsp;&nbsp;id_ciudad&nbsp;&nbsp;</th>
                            <th>&nbsp;&nbsp;id_moneda&nbsp;&nbsp;</th>
                        ...
                        <?php
                            ...
                            foreach ($monedaCollectorObj->showmoneda() as $c){
                            echo "<tr>";
                            echo "<td>" . $c->getId_ciudad() . "</td>";   
                            echo "<td>" . $c->getId_moneda() . "</td>";
				echo "<td>" . $c->getNombre() . "</td>";



                            echo "<td><a href='updatemoneda.php?id_ciudad=" . $c->getId_ciudad() . "&id_moneda=" . $c->getId_moneda() . "&nombre=" . $c->getNombre()."'><button class='btn btn-default btn-call-to-action'>Editar</button></a>  </td>"	;



                            echo "<td> <a href='deletemoneda.php?id_moneda=". $c->getId_moneda() ."'>
